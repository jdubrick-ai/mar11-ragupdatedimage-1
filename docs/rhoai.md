...
3) Access the `workbench` named `mar11-ragupdatedimage-1-notebook`.
...
5) In the terminal, run `cd mar11-ragupdatedimage-1` to navigate to your sample app's directory.
